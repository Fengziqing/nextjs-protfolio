...
const ContaceMe = () => {
    ...
    async function sendingData() {
        //Sending
        const sendingDialogue = document.getElementById(
            "message_sending",
        ...
        try {
            await axios
                .post(
                    "https://vercel-express-eosin.vercel.app/api/contact",
                    data,
                    {
                ...
                .then((response) => {
                    ...
                    ;(
                        document.getElementById("success")! as HTMLDialogElement
                    ).showModal()
            ...
            sendingDialogue.close()
            ;(
                document.getElementById("failed")! as HTMLDialogElement
            ).showModal()
            console.log(error)
        }
        // setSending(false);
    ...
    function handleSend(e: FormEvent) {
        ...
        if (message.length === 0) {
            setMessageErrorText(
                "Are you sure you don't wanna say anything⬆️🥺⬆️",
            )
            setTimeout(() => {
                setMessageErrorText("")
            }, 5000)
            ...
            setMessageErrorText(
                "Your message is too long ❌ , should shorter than 500 letters ✅",
            )
            setTimeout(() => {
                setMessageErrorText("")
            }, 5000)
    ...
    return (
        <div className=" block text-center">
            <p
                className=" text-center w-full p-3 justify-center text-lg leading-relaxed dark:text-white
                      sm:text-2xl sm:p-5
                      xl:text-4xl xl:p-10
            ...
            >
                ...
                <br />
                Want <span>Hire me</span>? Send me your <span>e-mail!📧</span>
                <br />
                Wanna Be friends with me?<span> Leave a message!⬇️</span>
                <br />
                ...
            </p>
            <div
                style={{ animation: "fadeInUp 0.9s" }}
                className="block sm:w-96 lg:w-[480px] w-80 mt-2 mb-10 text-center shadow-2xl bg-[#e8c8be] dark:bg-[#AEA885] rounded-3xl sm:py-8 py-6 sm:px-12 px-9 mx-auto"
            >
                <form
                    onSubmit={handleSend}
                    className="*:my-3 *:border-none *:rounded-2xl *:text-sm 
                ...
                >
                    ...
                    <button
                        className="btn sm:btn-wide text-white bg-[#deb0bd] dark:bg-gray-500 shadow-lg
            ...
            <dialog id="message_sending" className=" modal">
                <div className="modal-box bg-[#9A7EAE]">
                    ...
                    <h3 className="font-bold text-lg text-[#EBEDD4]">
                        Your Message is Sending...
                    </h3>
                    <Image
                        className=" mx-auto"
                        src="/images/sending-email.svg"
                        alt="sending"
                        width={100}
                        height={100}
                    />
                    <p className=" italic text-[#D3BA83]">
                        *You will receive a confirmation email if the message is
                        sent successfully.*
                    </p>
                </div>
            </dialog>
            ...
            <dialog id="success" className="modal modal-bottom sm:modal-middle">
                <div className="modal-box bg-[#B6C796]">
                    <Image
                        ...
                        src="/images/messages-sended.svg"
                        alt="messages-sended"
                        width={100}
                        height={100}
                    />
            ...
            <dialog id="failed" className="modal modal-bottom sm:modal-middle">
                <div className="modal-box bg-[#B63231]">
                    <Image
                        className=" mx-auto mb-2"
                        src="/images/messages-sended-fail.svg"
                        alt="messages-sended"
                        width={100}
                        height={100}
                    />
                    ...
                    <p className="py-4">
                        ...
                        <br />
                        <br /> If the issue persists, you can directly email to
                        fengziqing970202@gmail.com
                    </p>
                    <div className="modal-action">
                        <form method="dialog" className="mx-auto">
                            {/* if there is a button in form, it will close the modal */}
