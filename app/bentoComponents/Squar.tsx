...
const Squar = ({ imgsrc, imgalt, name }: { imgsrc: string, imgalt: string, name?: string }) => {
  if (imgalt === '') {
    return (
      <div className="w-44 h-44 overflow-hidden rounded-badge shadow-xl">
    ...
    return (
      <div className=" w-44 h-44 block relative overflow-hidden rounded-badge shadow-xl text-center">
